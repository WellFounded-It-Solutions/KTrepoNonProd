...
class VersionsFragment : BaseModule() {
        ...
        return ComposeView(requireContext()).apply {
            setContent {
                ...
                val styleData = StyleData(
                    itemBackgroundColor = theme.getColor(listOf("versionsItemBackground", "profileSectionItemBackground"), null)?.toComposeColor ?: Color.White,
                    ...
                    groupTextStyle = theme.getText(listOf("versionsSectionItemText", "profileSectionItemText"), null)?.toComposeTextStyle(theme) ?: TextStyle(color = Color(0xCC000000), fontSize = 14.sp),
                )
            ...
            CoroutineScope(Dispatchers.IO).launch { dependencyViewModel.getNavigaDependencies() }
        }
    }
