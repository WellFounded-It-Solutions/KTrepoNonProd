...
class DateUtilNorwegianTest(private val diff: Long, private val expected: String, private val now: Long) {
    ...
    companion object {
        ...
        fun data() = listOf(
                arrayOf(TimeUnit.SECONDS.toMillis(1),  "Nå", JAN_2020),
                arrayOf(TimeUnit.MINUTES.toMillis(1),  "Ett minutt siden", JAN_2020),
                arrayOf(TimeUnit.MINUTES.toMillis(5),  "5 minutter siden", JAN_2020),
                arrayOf(TimeUnit.MINUTES.toMillis(15),  "15 minutter siden", JAN_2020),
                arrayOf(TimeUnit.HOURS.toMillis(2),  "I dag 08:15", JAN_2020),
                arrayOf(TimeUnit.HOURS.toMillis(2),  "I dag 20:15", JAN_2020_NIGHT),
                arrayOf(TimeUnit.DAYS.toMillis(1),  "Tirsdag 10:15", JAN_2020),
                ...
                arrayOf(TimeUnit.DAYS.toMillis(2),  "Lørdag 10:50", NOV_2018),
                arrayOf(TimeUnit.DAYS.toMillis(6),  "Tirsdag 10:50", NOV_2018),
                arrayOf(TimeUnit.DAYS.toMillis(7),  "2018-11-12 10:50", NOV_2018),
                arrayOf(TimeUnit.DAYS.toMillis(1),  "Lørdag 10:15", MARCH_2020),
